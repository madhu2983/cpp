// Program to read a set of names from the keyboard and to sort the names in alphabetical order using bubble sort Algo. This program demonstrate how to implement and realise the array within the array of structure//
#include <iostream>
#include <cstring>
using namespace std;
